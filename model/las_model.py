...
class pBLSTMLayer(nn.Module):
    def __init__(self, input_feature_dim, hidden_dim, rnn_unit="LSTM", dropout_rate=0.3):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.pLSTM_layer0 = pBLSTMLayer(
            input_feature_dim, hidden_size, rnn_unit=rnn_unit, dropout_rate=0.3,
        )
        ...
        for i in range(1, self.num_layers):
            setattr(
                ...
                "pLSTM_layer" + str(i),
                pBLSTMLayer(
                    hidden_size * 2, hidden_size, rnn_unit=rnn_unit, dropout_rate=0.3,
                ),
            )
